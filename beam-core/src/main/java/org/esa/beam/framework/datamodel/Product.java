...
public class Product extends ProductNode {
    ...
    private final PlacemarkGroup textGroup;
    ...
    private synchronized PlacemarkGroup createTextGroup() {
        final VectorDataNode vectorDataNode = new VectorDataNode(TEXT_GROUP_NAME, Placemark.createTextFeatureType());
        vectorDataNode.setDefaultStyleCss("symbol:plus; stroke:#ff8800; stroke-opacity:0.8; stroke-width:1.0");
        vectorDataNode.setPermanent(true);
        this.vectorDataGroup.add(vectorDataNode);
        return vectorDataNode.getPlacemarkGroup();
    ...
    /**
     * Gets the group of text annotations (Texts).
     * Note that this method will create the group, if none exists already.
     *
     * @return the Text group.
     */
    public PlacemarkGroup getTextGroup() {
        return textGroup;
    }
