...
public final class DimapProductConstants {
    ...
    public static final String TAG_CPD_SOURCES_LOG_SCALED = "CPD_SOURCES_LOG_SCALED";
    public static final String TAG_CPD_SOURCES_MIN = "CPD_SOURCES_MIN";
    ...
    public static final String TAG_CPD_SOURCES_PALETTE_INITIALIZED = "PALETTE_INITIALIZED";
    public static final String TAG_CPD_SOURCES_CPD_FILE_NAME = "CPD_FILE_NAME";
    public static final String TAG_CPD_SOURCES_SCHEME_DEFAULT_LIST = "COLOR_SCHEME_DEFAULT_LIST";
