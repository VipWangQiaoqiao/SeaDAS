 ...
 */
public class ModisTiePointGeoCoding extends AbstractBowtieGeoCoding {
     ...
     */
    public ModisTiePointGeoCoding(TiePointGrid latGrid, TiePointGrid lonGrid, int scanlineHeight) {
    ...
    public boolean transferGeoCoding(final Scene srcScene, final Scene destScene, final ProductSubsetDef subsetDef) {
        ...
        return createGeocoding(destScene, ((ModisTiePointGeoCoding)srcScene.getGeoCoding()).getScanlineHeight());
    }
    ...
    private boolean createGeocoding(Scene destScene, int stripeHeight) {
        ...
        if (latGrid != null && lonGrid != null) {
            destScene.setGeoCoding(new ModisTiePointGeoCoding(latGrid, lonGrid, stripeHeight));
            return true;
        }
        return false;
    }
