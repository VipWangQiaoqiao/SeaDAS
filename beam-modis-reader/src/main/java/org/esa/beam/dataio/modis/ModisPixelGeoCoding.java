 ...
 */
public class ModisPixelGeoCoding extends AbstractBowtieGeoCoding {
     ...
     */
    public ModisPixelGeoCoding(Band latBand, Band lonBand) {
     ...
     */
    public ModisPixelGeoCoding(Band latBand, Band lonBand, int scanlineHeight, int scanlineOffsetY) {
    ...
    public boolean equals(Object o) {
        ...
        ModisPixelGeoCoding that = (ModisPixelGeoCoding) o;
    ...
    public boolean transferGeoCoding(final Scene srcScene, final Scene destScene, final ProductSubsetDef subsetDef) {
        ...
        ModisPixelGeoCoding srcGeocoding = (ModisPixelGeoCoding)srcScene.getGeoCoding();
        ...
        if (latBand != null && lonBand != null) {
            destScene.setGeoCoding(new ModisPixelGeoCoding(latBand, lonBand, getScanlineHeight(), destStripeOffsetY));
            return true;
        }
        return false;
    }
