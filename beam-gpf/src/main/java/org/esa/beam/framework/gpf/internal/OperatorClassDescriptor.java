...
public class OperatorClassDescriptor {
    ...
    /**
     * @return The action's metadata,
     *         or {@code null} if the action has no {@link org.esa.beam.framework.gpf.annotations.OperatorMetadata} annotation..
     */
    ...
    /**
     * @return The descriptor for the action's target product,
     *         or {@code null} if no action field has been declared with a {@link org.esa.beam.framework.gpf.annotations.TargetProduct} annotation..
     */
    ...
    /**
     * @return The descriptor for the action's source products (array),
     *         or {@code null} if no action field has been declared with a {@link org.esa.beam.framework.gpf.annotations.SourceProducts} annotation..
     */
    ...
    /**
     * @return The action's source products descriptors,
     *         or {@code null} if no action field has been declared with a {@link org.esa.beam.framework.gpf.annotations.SourceProduct} annotation..
     */
    ...
    /**
     * @return The action's parameter descriptors,
     *         or {@code null} if no action field has been declared with a {@link org.esa.beam.framework.gpf.annotations.Parameter} annotation.
     */
    ...
    /**
     * @return The action's target properties descriptors,
     *         or {@code null} if no action field has been declared with a {@link org.esa.beam.framework.gpf.annotations.TargetProperty} annotation.
     */
